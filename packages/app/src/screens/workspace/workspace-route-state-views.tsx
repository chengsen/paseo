  ...
  return (
    <View style={styles.emptyState}>
      ...
      <View style={styles.textStack}>
        <Text style={styles.title}>{t.workspace.loadingWorkspace}</Text>
    ...
    <View style={styles.emptyState}>
      ...
      <View style={styles.textStack}>
        ...
        <Text style={styles.description}>
          {state.connectionStatus === "connecting" || state.connectionStatus === "idle"
            ? state.hostName
            : t.workspace.hostStatus.replace(
                "{status}",
                formatConnectionStatus(state.connectionStatus),
              )}
        </Text>
        {state.lastError ? (
...
function WorkspaceMissing({ hostName, onDismiss }: { hostName: string; onDismiss: () => void }) {
  ...
  return (
    <View style={styles.emptyState}>
      <View style={styles.textStack}>
        <Text style={styles.title}>{t.workspace.workspaceNotFound}</Text>
        <Text style={styles.description}>{hostName}</Text>
      </View>
      <View style={styles.actions}>
