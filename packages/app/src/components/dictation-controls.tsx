  ...
  if (!showActiveState) {
    return (
      <Pressable
        ...
        accessibilityLabel={t.dictation.startVoiceDictation}
    ...
    <View style={styles.activeContainer}>
      ...
      <View style={styles.actionGroup}>
        <Pressable
          ...
          accessibilityLabel={t.dictation.cancelDictation}
        ...
        {!actionsDisabled && isFailed ? (
          <Pressable
            onPress={onRetry}
            accessibilityLabel={t.dictation.retryDictation}
        ...
        {!actionsDisabled && !isFailed ? (
          <>
            <Pressable
              onPress={onAccept}
              accessibilityLabel={t.dictation.insertTranscription}
            ...
            <Pressable
              ...
              accessibilityLabel={t.dictation.insertTranscriptionAndSend}
              style={ACTION_CONFIRM_STYLE}
            >
      ...
      <View style={overlayStyles.centerContainer}>
        ...
        {isFailed ? (
          <Text numberOfLines={2} style={overlayTranscriptTextStyle}>
            {errorText
              ? t.dictation.failed.replace("{errorText}", errorText)
              : t.dictation.failedTapRetry}
          </Text>
        ) : null}
      </View>
